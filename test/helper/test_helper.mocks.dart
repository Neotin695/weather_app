...
import 'package:weather_app/core/core.dart' as _i7;
import 'package:weather_app/data/data_source/data_source.dart' as _i9;
import 'package:weather_app/data/model/weather.dart' as _i3;
import 'package:weather_app/domain/entity/entity.dart' as _i8;
import 'package:weather_app/domain/repository/weather_repository.dart' as _i5;
import 'package:weather_app/domain/usecases/fetch_current_weather.dart' as _i10;
...
class MockWeatherRepository extends _i1.Mock implements _i5.WeatherRepository {
  ...
  @override
  _i6.Future<_i2.Either<_i7.Failure, _i8.WeatherEntity>> fetchCurrentWeather(
          String? cityName) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchCurrentWeather,
...
class MockWeatherRemoteDataSource extends _i1.Mock
  ...
  @override
  _i6.Future<_i3.WeatherModel> fetchCurrentWeather(String? cityName) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchCurrentWeather,
          [cityName],
...
class MockFetchCurrentWeatherUseCase extends _i1.Mock
    implements _i10.FetchCurrentWeatherUseCase {
